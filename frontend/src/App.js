...
const PageLoader = () => (
  <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
    ...
    <div className="flex flex-col items-center gap-1">
      <span className="text-sm font-bold text-slate-700 tracking-wider uppercase">AP POLITICAL WATCH · TDP</span>
      <span className="text-[11px] text-slate-400 tracking-widest uppercase">Social Media Intelligence for TDP Andhra Pradesh</span>
    </div>
  </div>
);
