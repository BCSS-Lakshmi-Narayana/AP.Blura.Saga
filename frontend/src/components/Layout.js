...
const Layout = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-col bg-background overflow-hidden relative print:h-auto print:overflow-visible">
      ...
      <header className="fixed top-0 left-0 right-0 h-16 lg:h-20 bg-gradient-to-r from-yellow-700 via-yellow-600 to-yellow-500 z-50 shadow-lg select-none overflow-hidden">
        {/* TDP accent ribbon — top edge */}
        ...
        <div className="flex items-center justify-between h-full px-4 lg:px-6 relative">
          <div className="flex items-center gap-3 lg:gap-4 relative z-10">
            ...
            <div className="flex items-center gap-3 lg:gap-4">
              ...
              <div className="flex flex-col items-start justify-start text-left leading-tight">
                ...
                <span className="hidden sm:block text-[9px] lg:text-[10px] text-yellow-50 font-semibold tracking-widest uppercase">
                  TDP Leadership Monitoring · Andhra Pradesh
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <div className="hidden md:flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-white/15 border border-white/25 backdrop-blur-sm">
              ...
              <span className="text-[10px] font-bold uppercase tracking-widest text-white">Live · Andhra Pradesh</span>
            </div>

            <img src="/Logo.png" alt="TDP Logo" className="h-8 lg:h-10 w-auto object-contain" />
      ...
      <aside
        className={`fixed top-16 lg:top-20 left-0 bottom-0 w-[82px] bg-gradient-to-b from-yellow-700 via-yellow-600 to-yellow-500 shadow-xl z-40 transform transition-transform duration-300 ease-in-out select-none ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}
        data-testid="sidebar"
        role="navigation"
