      ...
      <div style={{ width: '100%', height }}>
        <ResponsiveContainer>
          <AreaChart data={data} margin={{ top: 4, right: 8, left: -16, bottom: 0 }}>
            ...
            <Area type="monotone" dataKey="neutral" name="Neutral" stroke="#f59e0b" fill="url(#geoNeutral)" strokeWidth={1.5} />
            <Area type="monotone" dataKey="positive" name="Positive" stroke="#10b981" fill="url(#geoPositive)" strokeWidth={2} />
            <Area type="monotone" dataKey="negative" name="Negative" stroke="#ef4444" fill="url(#geoNegative)" strokeWidth={2} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
