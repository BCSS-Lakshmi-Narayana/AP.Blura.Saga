...
export const PARTY_COLORS = {
  TDP: { main: '#eab308', soft: '#fef9c3', text: '#854d0e', ring: '#facc15', grad: 'from-yellow-400 to-amber-500' },
  JSP: { main: '#dc2626', soft: '#fee2e2', text: '#991b1b', ring: '#ef4444', grad: 'from-red-500 to-rose-600' },
  BJP: { main: '#f97316', soft: '#ffedd5', text: '#9a3412', ring: '#fb923c', grad: 'from-orange-400 to-orange-600' },
  YSRCP: { main: '#2563eb', soft: '#dbeafe', text: '#1e40af', ring: '#3b82f6', grad: 'from-blue-500 to-indigo-600' },
