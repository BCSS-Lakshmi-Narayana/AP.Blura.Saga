      ...
      >
        ...
        <div className="absolute top-2 left-3 bg-white/95 border border-slate-200/80 rounded-lg shadow-md p-2 z-10 max-w-[155px] text-[9px]">
          ...
          <div className="space-y-0.5">
            ...
            {viewMode === 'party' && (
              <>
                <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded bg-[#facc15]" />TDP</div>
                <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded bg-[#dc2626]" />JSP</div>
                <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded bg-[#f97316]" />BJP</div>
                <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded bg-[#2563eb]" />YSRCP</div>
              </>
            )}
          </div>
        </div>
