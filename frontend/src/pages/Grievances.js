...
const Grievances = () => {
    ...
    // ─── Tracked keywords (TDP auto-fetcher) ──────────────────────
    ...
    const fetchTrackedKeywords = useCallback(async () => {
        ...
        try {
            ...
            // Show TDP / mention-style keywords first
        ...
        <div className="p-4 md:p-6 space-y-0 bg-slate-50 min-h-screen flex flex-col">
            ...
            <Dialog open={keywordsOpen} onOpenChange={setKeywordsOpen}>
                <DialogContent className="max-w-2xl">
                    <DialogHeader>
                        <DialogTitle className="flex items-center gap-2">
                            <Tag className="h-4 w-4 text-orange-600" /> TDP Tracking Keywords
                        </DialogTitle>
                    </DialogHeader>
                    <div className="space-y-3 pt-1">
                        <p className="text-xs text-muted-foreground">
                            These keywords are what the auto-fetcher searches every 10–30 minutes. Add anything related to Chandrababu Naidu / the TDP — names, hashtags, opposition keywords, constituency landmarks. Telugu, Hindi and English all work.
                        </p>
