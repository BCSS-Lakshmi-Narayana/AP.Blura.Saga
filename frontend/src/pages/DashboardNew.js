  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-300" data-testid="dashboard">
      ...
      <div className="flex items-center justify-between">
        ...
        {/* Andhra Pradesh Constituency Map — Always Visible */}
        <Card className="border border-border/50 shadow-sm hover:shadow-md transition-all overflow-hidden lg:col-span-1">
          <div className="flex items-center justify-between px-5 py-3 border-b border-border/30">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-[13px] font-semibold text-foreground">Andhra Pradesh Constituencies</h3>
            </div>
            <span className="text-[10px] text-muted-foreground font-medium">TDP Leadership · Constituency-wide</span>
          </div>
