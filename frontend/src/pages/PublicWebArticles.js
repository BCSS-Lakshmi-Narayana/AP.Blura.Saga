...
import { CalendarDays, ExternalLink, Globe, Newspaper, Search } from 'lucide-react';
    ...
    <div className="p-6 max-w-5xl mx-auto">
      <div className="flex flex-wrap items-start gap-3 mb-5">
        <div className="flex items-center gap-3">
          <span className="h-10 w-10 rounded-xl bg-yellow-600 text-white inline-flex items-center justify-center shadow-md">
            <Newspaper className="h-5 w-5" />
          </span>
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Public Web Articles</h1>
        ...
        <CardContent className="p-4 sm:p-5 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <Button
              ...
              onClick={runSearch}
              disabled={isLoading}
              className="h-11 sm:px-6 bg-yellow-600 hover:bg-yellow-700 text-white"
            >
